window.SocialShareButton =
  ...
  share : (el) ->
    ...
    switch site
      ...
      when "facebook"
        SocialShareButton.openUrl("https://www.facebook.com/dialog/feed?app_id=#{facebook_appid}&link=#{url}&picture=#{img}&redirect_uri=#{redirect_uri}&name=#{title}&display=popup",popup)
      when "qq"
